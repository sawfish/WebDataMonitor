...
public class TextPersistentManagedFeeds implements PersistentManagedFeeds {
	Logger log = Logger.getLogger(TextPersistentManagedFeeds.class);
	public TextPersistentManagedFeeds() {
	...
	/* (non-Javadoc)
	 * @see cshen.data.collection.PersistentManagedFeeds#loadFeeds()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cshen.data.collection.PersistentManagedFeeds#saveFeeds(cshen.data.collection.ManagedFeeds)
	 */
	@Override
